...
from src.data_loading.load_data import load_data                    # Data loading with error handling
from src.data_loading.preprocess import preprocess_data            # Basic data cleaning
...
def main(args):
    ...
    if args.mlflow_uri:
        ...
        # Windows-specific URI handling
        if os.name == 'nt':  # Windows
            # Convert Windows path to proper file URI
            import urllib.parse
            mlruns_dir_abs = os.path.abspath(mlruns_dir)
            # file:///C:/Users/RITS/Desktop/churn/mlruns
            mlruns_path = f"file:///{mlruns_dir_abs.replace('\\', '/').lstrip('/')}"
...
if __name__ == "__main__":
    ...
    p.add_argument("--input", type=str, required=True,
                   help="path to CSV (e.g.,data/WA_Fn-UseC_-Telco-Customer-Churn.csv)")
