...
from data_loading.preprocess import preprocess_data
from features.build_features import build_features

# === CONFIG ===
DATA_PATH = "data/WA_Fn-UseC_-Telco-Customer-Churn.csv"  # adjust to your file path
TARGET_COL = "Churn"
...
def main():
    ...
    df_features.to_csv('data/preprocessed_data.csv', index=False)
